...
def plot_cluster(num_cls, df, n, scale=False):
    ...
    new_df['label'] = 'o'
    new_df.loc[new_df.response == 'cured', 'label'] = '*'
    #####PLOT#####
    from matplotlib.lines import Line2D
    fig, ax = plt.subplots(1, figsize=(8, 8))
    # plot data
    ...
    # title and labels
    plt.title('Clusters of Donors', loc='left', fontsize=22)
...
def plot_treatment(df, name):
    ...
    # title and labels
    plt.title('Donors in ImProVIT', loc='left', fontsize=22)
